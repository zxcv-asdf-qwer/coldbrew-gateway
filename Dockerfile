...
ENTRYPOINT ["java","-Djava.security.egd=file:/dev/./urandom","-Duser.country=KR","-Duser.language=ko","-XX:+HeapDumpOnOutOfMemoryError","-XX:HeapDumpPath=/tmp/dump.hprof","-jar","/app.jar"]
